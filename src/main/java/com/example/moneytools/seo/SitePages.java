...
public final class SitePages {
    ...
    public static final List<PageInfo> ALL = List.of(
            ...
            new PageInfo("loan", "/loan-interest-calculator", "대출이자 계산기", "대출이자 계산기 | 원리금균등·원금균등 계산", "대출금액·금리·기간을 입력하면 원리금균등·원금균등·만기일시상환의 월 납입액과 총이자를 비교합니다.", true, true, BASE_REFRESHED_AT),
            ...
            new PageInfo("annual-salary-net", "/annual-salary-net-calculator", "연봉 실수령액 계산기", "2026 연봉 실수령액 계산기 | 세후 월급 계산", "연봉과 비과세·부양가족 조건을 입력하면 월 세후급여와 4대보험·소득세 공제액을 계산합니다.", true, true, SEO_REFRESHED_AT),
            ...
            new PageInfo("electricity-bill", "/electricity-bill-calculator", "전기요금 계산기", "전기요금 계산기 | 가정용 누진요금 참고 계산", "월 사용량(kWh)을 입력하면 가정용 누진구간과 기본요금, 전력량요금, 부가세·기금을 반영한 예상 전기세를 계산합니다.", true, true, SEO_REFRESHED_AT),
            new PageInfo("air-conditioner-cost", "/air-conditioner-electricity-calculator", "에어컨 전기세 계산기", "에어컨 전기세 계산기 | 하루 8시간 사용 전기요금 계산", "에어컨 소비전력과 하루 사용시간을 입력하면 월 사용량과 가정 전체 누진요금을 반영한 예상 전기세를 계산합니다.", true, true, SEO_REFRESHED_AT),
