...
public final class SitePages {
    private static final LocalDate SEO_REFRESHED_AT = LocalDate.of(2026, 5, 27);
    ...
    public static final List<PageInfo> ALL = List.of(
            ...
            new PageInfo("overseas-tax", "/overseas-stock-tax-calculator", "해외주식 세금 계산기", "해외주식 세금 계산기 | 양도소득세·배당세 바로 계산", "해외주식 매수금액, 매도금액, 수수료, 환율을 입력해 양도소득세와 배당세를 예상 계산합니다. 기본공제 250만원 적용 여부도 확인하세요.", true, true, SEO_REFRESHED_AT),
            ...
            new PageInfo("guide-stock-tax", "/guide/stock-tax", "주식 세금 계산 방법 총정리", "주식 세금 계산 방법 총정리 | 국내·해외주식 세금 비교", "국내주식 세금, 해외주식 양도소득세, 배당소득세, 증권거래세 차이를 정리하고 관련 계산기로 예상 세금을 확인하세요.", true, false, SEO_REFRESHED_AT),
            new PageInfo("guide-overseas-stock-tax", "/guide/overseas-stock-tax", "해외주식 양도소득세 계산 방법", "해외주식 양도소득세 계산 방법 | 250만원 기본공제와 과세표준", "해외주식 양도차익, 기본공제 250만원, 과세표준, 예상세금 계산 흐름을 설명하고 해외주식 세금 계산기로 연결합니다.", true, false, SEO_REFRESHED_AT),
            new PageInfo("guide-dividend-tax", "/guide/dividend-tax", "배당소득세 계산 방법", "배당소득세 계산 방법 | 세전·세후 배당금 계산", "세전 배당금, 세후 배당금, 배당소득세 15.4% 계산 예시를 정리하고 배당 계산기로 연결합니다.", true, false, SEO_REFRESHED_AT),
